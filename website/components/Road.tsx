...
// Assets
const road = [
  { src: 'https://res.cloudinary.com/djxfy60tt/image/upload/v1776103168/road01_kf0sow.png', title: "Regional Road Network" },
  { src: 'https://res.cloudinary.com/djxfy60tt/image/upload/v1776103157/road02_s2ueej.png', title: "Urban Infrastructure" },
];
...
export default function Road() {
  return (
    <section id="road_construction" className="w-full py-16 md:py-24 bg-white scroll-mt-[60px]">
        ...
        <div className="grid lg:grid-cols-12 gap-6 md:gap-10 mb-10 md:mb-16 items-start lg:items-center">
          <div className="lg:col-span-7">
            ...
            <h1 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tight leading-tight">
              ROAD <br className="md:hidden" /> CONSTRUCTION
            </h1>
          </div>
          <div className="lg:col-span-5">
            <p className="text-slate-600 text-sm md:text-lg leading-relaxed font-light border-l-2 border-blue-600 pl-5 md:pl-6">
              At HH Consulting Architects & Engineers, we design and construct roads that 
              weave together Ethiopia&apos;s rich cultural tapestry and socio-economic aspirations.
            </p>
          </div>
        </div>

...
const terminal_projects = [
  { src: 'https://res.cloudinary.com/djxfy60tt/image/upload/v1776102347/Jima_airport_qmf220.png', title: "Jima Airport" },
  { src: 'https://res.cloudinary.com/djxfy60tt/image/upload/v1776102347/axum_airport_ymuhwv.png', title: "Axum Airport" },
  { src: 'https://res.cloudinary.com/djxfy60tt/image/upload/v1776102348/gambela_airport_uj1f8v.png', title: "Gambela Airport" },
  { src: 'https://res.cloudinary.com/djxfy60tt/image/upload/v1776102350/Bus_terminal_ihqdmd.png', title: "Bus Terminal" }
];
...
export default function TerminalDesign() {
  return (
    <section id="terminal_design" className="w-full py-16 md:py-24 bg-white scroll-mt-[60px]">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid lg:grid-cols-12 gap-6 md:gap-10 mb-10 md:mb-16 items-start lg:items-center">
          ...
          <div className="lg:col-span-5">
            <p className="text-slate-600 text-sm md:text-lg leading-relaxed font-light border-l-2 border-blue-600 pl-5 md:pl-6">
              At HH Consulting Architects & Engineers, we redefine transportation terminals 
              as gateways to Ethiopia&apos;s past, present, and future.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
          {terminal_projects.map((item, index) => (
            <div key={index} className="relative group overflow-hidden rounded-2xl aspect-[4/3] md:aspect-[16/10] lg:aspect-[4/3]">
              <ImageWithLoader 
                src={item.src} 
                alt={item.title} 
                fill 
